...
if __name__ == "__main__":
    ...
    for it in range(FLAGS.iter): 
        ...
        flexicubes_mesh.auto_normals() # compute face normals for rendering
        buffers = render.render_mesh_paper(flexicubes_mesh, mv, mvp, FLAGS.train_res, ["mask", "depth", "normal"])
